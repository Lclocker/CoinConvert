...
class CoinDestinyPage extends StatefulWidget {
  const CoinDestinyPage({ Key? key }) : super(key: key);

  @override
  _CoinDestinyPageState createState() => _CoinDestinyPageState();
}

class _CoinDestinyPageState extends State<CoinDestinyPage> {
          ...
          return Container(
            ...
            child: Card(
              ...
              child: ListTile(
                ...
                dense: true,
                onTap: () async {
                  await (coinDestiny = listCoin[index]);
